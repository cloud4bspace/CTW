    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<FloatingActionButton>(R.id.fab).setOnClickListener { view ->
            Snackbar.make(view, "Replace with your own action", Snackbar.LENGTH_LONG)
                ...
                //Navigation.findNavController(this, R.id.nav_host_fragment_container).navigate(R.id.additemFragment);
               // supportFragmentManager.beginTransaction().replace(R.id.nav_host_fragment, AdditemFragment()).commit()
